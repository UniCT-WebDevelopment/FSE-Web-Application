...
<div class=" main" style="text-align: center; font-size:15px ; padding:15px;  font-family: 'Open Sans', sans-serif;">
    <h1 style="text-align: left; color:#641220; font-weight:bold" > Recupero Informativa  </h1> 
    <br> 
    ...
    <br>
        ...
        <?php
                    ...
                    $curlSES=curl_init(); 
                        ...
                        curl_setopt($curlSES,CURLOPT_URL,"http://localhost:8888/fse/recuperoInformativa"); //http://localhost:8888/fse/recuperoInformativa  http://localhost:3000/fse/consenso/recuperoinformativaprova
                        ...
                        if (( $http_code != "200" )) {
                            ...
                            curl_close($curlSES);
                                ...
                                elseif ($result["esito"] == 0000) {
                                    ...
                                    $doc_pdf = fopen("./assets/document/informativa.pdf", "w");
                                    fwrite($doc_pdf,$pdf_decoded);
                                    fclose($doc_pdf);
                                    
                                    header('Content-type: application/pdf');

                                    $doc = file_get_contents('./assets/document/informativa.pdf');
                                    
                                echo "<iframe  align='center' src='/assets/document/informativa.pdf' width='100%' height='1200px'></iframe>";
                                }
                            }
            }
